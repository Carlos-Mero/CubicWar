...
extern "C" {
// Initialization.
GDExtensionBool GDE_EXPORT cubic_war_modules_init(const GDExtensionInterface *p_interface, const GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization) {
